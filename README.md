...
✅ Markdown API documentation generated with [TypeDoc](https://typedoc.org/) & [`typedoc-plugin-markdown`](https://typedoc-plugin-markdown.org/).<br>
...
Markdown API documentation is generated by [TypeDoc](https://typedoc.org/) and [`typedoc-plugin-markdown`](https://typedoc-plugin-markdown.org/).

Here's how to use this feature:

- Document your code with TSDoc comments as usual.

- Configure docs generation in [`typedoc.json`](./typedoc.json). Browse [this repo](https://github.com/typedoc2md/typedoc-plugin-markdown-examples/blob/main/README.md) for tons of examples!

- Run `npm run docs` to generate your API documentation in the `docs` directory. Docs will also be generated during your release process. If there are any updates, this will dirty your working directory and your release will fail, so be sure to run `npm run docs` and commit any changes before running `npm run release`.

- Link to your main API documentation page at [`docs/README.md`](./docs/README.md) from this README.
